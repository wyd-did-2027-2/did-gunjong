...
export const content = {
  kr: {
    lang: "ko",
    metadata: {
      title: "WYD SEOUL 2027 DID 군종",
      description: "WYD SEOUL 2027 DID 군종 공식 웹사이트",
      ogLocale: "ko_KR",
    },
    header: {
  ...
  en: {
    lang: "en",
    metadata: {
      title: "WYD SEOUL 2027 DID Military Ordinariate",
      description: "WYD SEOUL 2027 DID Military Ordinariate Official Website",
      ogLocale: "en_US",
    },
    header: {
